    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                {l s='Ajouter au panier' d='Shop.Theme.Checkout'}
            ...
            <div class="modal-body">
                ...
                <div class="modal-cart__content">
                    ...
                    <p>
                        ...
                        <span class="subtotal">{$cart.subtotals.products.value}</span>
                    </p>
                    {if $cart.subtotals.shipping.value}
                        <p>
                            <span>{l s='Shipping:' d='Shop.Theme.Checkout'}</span>
                            <span class="shipping">{$cart.subtotals.shipping.value} {hook h='displayCheckoutSubtotalDetails' subtotal=$cart.subtotals.shipping}</span>
                        </p>
                    {/if}
                    ...
                    <div class="cart-content-btn">
                        <a href="{$cart_url}" class="btn btn-primary"></i>{l s='Proceed to checkout' d='Shop.Theme.Actions'}</a>
