...
<section class="contact-form">
    <div class="contact-header">
        <h1>{l s='Service client' d='Shop.Theme.Global'}</h1>
    </div>
    <div class="contact-content">
        <div class="contact-intro">
            <p>{l s="Veuillez visiter nos questions fréquemment posées"}&nbsp;<a href="#" target="_self">(FAQ)</a></p>
            <br>
            <h2>{l s="Formulaire de contact" d='Shop.Theme.Global'}</h2>
            <p>{l s="Nous vous recommendons de remplir le formulaire ce-dessous avec toutes les détails possibles afin de traiter votre demande dans les plus brefs délais." d='Shop.Theme.Global'}</p>
        </div>
        <form action="{$urls.pages.contact}" method="post" {if $contact.allow_file_upload}enctype="multipart/form-data"{/if}>
            ...
            {if !$notifications || $notifications.nw_error}
                ...
                <footer class="form-footer">
                    ...
                    <input class="btn btn-primary" type="submit" name="submitMessage" value="{l s='Soumettre' d='Shop.Theme.Actions'}">
                </footer>
            {/if}
